...
public class UserInterface extends JPanel {
    ...
    static long UniversalWP=0L,UniversalWN=0L,UniversalWB=0L,UniversalWR=0L,
            ...
            UniversalEP=0L;
    static boolean UniversalCWK=true,UniversalCWQ=true,
            UniversalCBK=true,UniversalCBQ=true;//true=castle is possible
    ...
    static JFrame javaF=new JFrame("JARVICE");//must be declared as static so that other class' can repaint
    ...
    public static void main(String[] args) {
      ...
      //newGame();
        ...
        BoardGeneration.importFEN("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq - 0 1");
    ...
    @Override
    public void paintComponent(Graphics g) {//adjusting to window resizing
