...
public class BoardGeneration {
    ...
    public static void initiateStandardChess() {
        ...
        String chessBoard[][]={  /**initial game*/ 
                {"r","n","b","q","k","b","n","r"},
                {"p","p","p","p","p","p","p","p"},
                {" "," "," "," "," "," "," "," "},
                {" "," "," "," "," "," "," "," "},
    ...
    public static void initiateChess960() {
        ...
        String chessBoard[][]={  /**initial game*/ 
                ...
                {"P","P","P","P","P","P","P","P"},
                {" "," "," "," "," "," "," "," "}};
        //step 1: Place bishops on a random integer
        int random1 = (int) (Math.random() *8);
        chessBoard[0][random1]  = "b";
        chessBoard[7][random1]  = "B";
        
        //step 2: Place the other bishop on a different color square
        ...
        //step 3: Place the queen(skipping filled positions)
        ...
        int counter = 0;
        int loop = 0;
        while(counter - 1 < random4a){//finds "random4a'th empty position
        ...
        int random4b = (int) (Math.random() *5);
        counter =0;
        loop = 0;
        while(counter - 1 < random4b){//finds "random4a'th empty position
        	if(" ".equals(chessBoard[0][loop])){
        		counter++;
        	}
        	loop++;
        ...
        //step 5:find empty spot and place rook, then king and then rook 
        counter = 0;
    ...
    public static void arrayToBitboards(String[][] chessBoard,long WP,long WN,long WB,long WR,long WQ,long WK,long BP,long BN,long BB,long BR,long BQ,long BK) {
        ...
        for(int i = 0; i < Long.numberOfLeadingZeros(BP); i++) {
            System.out.print('0');
      }*/
      //System.out.println(Long.toBinaryString(BP));
      
      sendBitBoards(WP,WN,WB,WR,WQ,WK,BP,BN,BB,BR,BQ,BK);
      //System.out.println("Hey" +WP);  
      drawArray(WP,WN,WB,WR,WQ,WK,BP,BN,BB,BR,BQ,BK); /** Bitboard back to array*/
        
    }
    private static void sendBitBoards(long WP,long WN,long WB,long WR,long WQ,long WK,long BP,long BN,long BB,long BR,long BQ,long BK) {
